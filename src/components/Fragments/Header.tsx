  ...
  return (
    <header className="flex flex-col gap-3 lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-between lg:py-24">
          ...
          <ul className="mt-16 w-max">
              ...
              >
                <span
                  className={`nav-indicator mr-4 h-px w-8 transition-all group-hover:w-16 group-hover:bg-slate-200 group-focus-visible:w-16 group-focus-visible:bg-slate-200 motion-reduce:transition-none ${
                    active === 'about' ? 'w-16 bg-slate-200' : 'bg-slate-600 '
                  }`}
                />
                <span
                  className={`nav-text text-xs font-bold uppercase tracking-widest group-hover:text-slate-200 group-focus-visible:text-slate-200 ${
                    active === 'about' ? 'text-slate-200' : 'text-slate-500'
                  }`}
                >
                  About
                </span>
            ...
            <li>
              ...
              >
                ...
                <span
                  className={`nav-text text-xs font-bold uppercase tracking-widest group-hover:text-slate-200 group-focus-visible:text-slate-200 ${
                    active === 'projects' ? 'text-slate-200' : 'text-slate-500'
                  }`}
                >
                  Projects
                </span>
      ...
      <div className="flex gap-5 mt-3">
        <a href=" https://github.com/ahmadwaldi13" target="_blank">
          <svg
            className="w-6 h6 text-slate-400"
            fill="currentColor"
            viewBox="0 0 16 16"
        ...
        <a
          href="https://www.linkedin.com/in/ahmad-waldi-arridho-911395244"
          target="_blank"
        >
          <svg
        ...
        <a
          href="https://www.instagram.com/ahmadwaldiarridho_/?igsh=a2tuMm14aTRvcXI4"
          target="_blank"
        >
          <svg
            className="w-6 h6 text-slate-400"
